...
<Box  sx={styles.techOrbit}>
  <Box className="techWrapper" style={{ transform: 'rotate(0deg) translateY(-180px)' }}>
    <img src={mongo} alt="MongoDB" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(36deg) translateY(-170px)' }}>
    <img src={express} alt="Express" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(72deg) translateY(-140px)' }}>
    <img src={reactLogo} alt="React" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(108deg) translateY(-120px)' }}>
    <img src={node} alt="Node.js" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(144deg) translateY(-130px)' }}>
    <img src={javascript} alt="JavaScript" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(180deg) translateY(-120px)' }}>
    <img src={tailwindcss} alt="Tailwind CSS" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(216deg) translateY(-140px)' }}>
    <img src={html} alt="HTML" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(252deg) translateY(-160px)' }}>
    <img src={css} alt="CSS" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(288deg) translateY(-170px)' }}>
    <img src={next} alt="Next.js" className="techIcon" />
  </Box>
  <Box className="techWrapper" style={{ transform: 'rotate(324deg) translateY(-180px)' }}>
