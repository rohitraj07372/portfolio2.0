        ...
        <Paper elevation={0} sx={{ bgcolor: "transparent" }}>
          ...
          <Box
            sx={{
              ...
              width: "100%",
              background:
                "linear-gradient(90deg, #f27121 0%, #e94057 46%, #8a2387 100%)",
              position: "absolute",
              top: 0,
              left: 0,
          ...
          >
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography
                sx={{
                  fontSize: "0.98rem",
                  color: darkMode ? "#d8d6d6ff" : "#9c9b9bff",
                  lineHeight: 1.05,
                }}
              >
                {user.location}
          ...
          >
            ...
            <IconButton
              sx={{ ml: 0.1, color: darkMode ? "#e2e2e2ff" : "#222" }}
            >
          ...
          <Box sx={{ px: 2, pt: 0.8, pb: 1, maxWidth: "100%" }}>
            ...
            <Typography
              ...
              sx={{
                fontSize: "0.96rem",
                ml: 0.7,
                color: darkMode ? "#e2e2e2ff" : "#2e2e2eff",
              }}
            >
              {" "}
              Software Engineer
            ...
            <Box sx={{ mt: 0.5, wordBreak: "break-word" }}>
              <Typography
                component="span"
                sx={{
                  color: darkMode ? "#949494ff" : "#4d4c4cff",
                  fontSize: "0.95rem",
                }}
              >
